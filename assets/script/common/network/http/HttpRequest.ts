...
export default class HttpRequest{
    ...
    ontimeout ()
    {
        ...
        this._logInfo.pushLog("reTryTimes:"+this._reTryTimes+"  timeout" + request.timeout);

        this.reTry(this._onTimeoutCallBack);
    }
    ...
    onerror ()
    {
        ...
        this.reTry(this._onErrorCallBack);
    }
    ...
    {
        this._reTryTimes += 1;
        if(this._reTryTimes < this._tryCount)
        {
            //Todo
            this.initRequest();
            this.send();
